...
export function TeacherView({ isOpen, onClose, rowdata }) {
    ...
    <input type="file" name="aadhar" id="aadhar" accept="image/pdf*" onChange={handleChange} />
        ...
        <Section title="Service_Details">
            ...
            <Input label="Appointed Subject" type="text" maxLength={2} name="appointed_subject" value={teacherinfo.appointed_subject} onChange={handleChange} />
            ...
            <Input label="Teacher School Guest Contractual" maxLength={2} type="text" name="teacher_school_guest_contractual" value={teacherinfo.teacher_school_guest_contractual} onChange={handleChange} />
        </Section>
