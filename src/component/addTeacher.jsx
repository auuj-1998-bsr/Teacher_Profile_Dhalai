...
export default function TeacherForm() {
    ...
    const initialState = {
        ...
        doj_service: "", appointed_for_level: "", appointed_subject: "", sub_taught_1: "", sub_taught_2: "", teacher_school_guest_contractual: "",
    };
    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-lg space-y-8 max-w-6xl mx-auto">
            ...
            <Section title="Service_Details">
                ...
                <Input label="Appointed Subject" type="number" max={2} name="appointed_subject" value={teacherinfo.appointed_subject} onChange={handleChange} />
                ...
                <Input label="Teacher School Guest Contractual" max={2} type="number" name="teacher_school_guest_contractual" value={teacherinfo.teacher_school_guest_contractual} onChange={handleChange} />
            </Section>
